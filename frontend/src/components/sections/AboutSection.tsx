      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          >
            <div className="relative">
              ...
              <img 
                ...
                alt="Farmers using AgroSmart technology"
          ...
          >
            ...
            >
              AgroSmart was founded in 2020 with a vision to revolutionize farming in India by bringing together technology, data science, and agricultural expertise. We believe that every farmer deserves access to cutting-edge tools that can increase productivity and sustainability.
            </motion.p>
            <motion.p
              variants={fadeInUp}
              className="text-gray-600 mb-6"
