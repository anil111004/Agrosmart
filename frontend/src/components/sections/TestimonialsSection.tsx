...
const testimonials = [
  {
    ...
    rating: 5,
    text: "AgroSmart's soil analysis and crop recommendations have transformed my farming practices. I've seen a 40% increase in yield and significant cost savings on fertilizers by using just what my soil needs."
  },
  {
    id: 2,
    name: "Lakshmi Devi",
  ...
  },
  {
    ...
    rating: 4,
    text: "I was skeptical about technology in farming, but the AgroSmart app is so user-friendly. The disease prediction feature helped me save my tomato crop from blight by identifying it early."
  },
  {
    id: 4,
    name: "Priya Patel",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Hear from farmers who have transformed their agricultural practices using AgroSmart.
          </p>
        </div>
